...
---
    flowchart LR
        ...
        click Fa1 "/family?msg=蔣超元:譜名仁孝,生於1870年2月24日,歿於民國32年（1943年）陰曆11月11日,葬於雙江鎮老鸛嘴新房子山後"
        
        Mo1(蔣胡氏):::green --- G3 
        click Mo1 "/family?msg=蔣胡氏:生於1880年6月14日,歿於民國46年（1957年),葬於雙江鎮老鸛嘴新房子山後"
    
        %% GENERATION 8 %%
        G3 --長子--> Fa(蔣文彬):::green --- G2(入臺第一代):::blue
        click Fa "/family?msg=蔣文彬:譜名必兵,生於民國11年（1922年）陰曆1月1日於四川潼南雙江鎮老鸛嘴新房子,歿於民國73年（1984年）陽曆10月19日於臺北榮總,葬於臺北觀音山,配劉文筠,育有二子五女"

        Mo(劉文筠):::green --- G2
        click Mo "/family?msg=劉文筠:譜名祖貞,生於民國14年（1925年）陰曆6月15日於雙江鎮外北街10號,歿於民國110年（2021年）陰曆1月14日於臺北家中,與夫同葬於台北觀音山"
        
        %% GENERATION 9 %%
        G2 --> S0(蔣大毛)
        click S0 "/family?msg=蔣大毛:生於民國35年（1946年）6月13日於重慶,然未及7日即夭折"
        G2 --長女--> S1(蔣玉芳)
        G2 --長子--> Or(蔣玉華):::green
        S0 --- G1
        S1 --- G1
