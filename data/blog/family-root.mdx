...
<div className="flex flex-wrap rounded-2xl border-l-2 border-indigo-500">
  <ul>
    <li key='1' className="pl-4 md:pl-1">入川第七代（仁字輩）</li>
    <li key='2' className="pl-4 md:pl-1">
    ...
    <li key='3' className="pl-4 md:pl-1">
      <div className="relative inline-block group">
    ...
    <li key='4' className="pl-4 md:pl-1">入川第八代（必字輩）入臺第一代</li>
    <div className="flex flex-wrap rounded-2xl border-l-2 border-indigo-500">
      <ul>
        <li key='1' className="pl-4 md:pl-1">
          <div className="relative inline-block group">
        ...
        <li key='3' className="pl-4 md:pl-1">入川第九代（愈字輩）入臺第二代</li>
        <div className="flex flex-wrap rounded-2xl border-l-2 border-indigo-500">
          <ul>
            <li key='2' className="pl-4 md:pl-1">
              <div className="relative inline-block group">
        ...
        <div className="flex flex-wrap rounded-2xl border-l-2 border-indigo-500">
          <ul>
            <li key='2' className="pl-4 md:pl-1">
              <div className="relative inline-block group">
                <span className="hover:bg-blue-600">長 女： 蔣玉芳 1948 - </span>
            ...
            <div className="flex flex-wrap rounded-2xl border-l-2 border-indigo-500">
              <ul>
                <li key='5' className="pl-4">
                  女：張婷怡<br/>
                  婿：姜廷霖
                </li>
                <div className="flex flex-wrap rounded-2xl border-l-2 border-indigo-500">
                  <ul>
                    <li key='6' className="pl-4">
                      女：姜勻婕
                    </li> 
                  </ul>
                </div>
